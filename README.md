...
# 2) Automated execution (optional)
  ...
  a) General tab:
      ...
      Give the task a name (e.g. Model1_Buy / Model1_Sell) and check:
  ...
  b) Triggers tab
      ...
      Create a new trigger then set:
   
        1)Begin the task: On a schedule
        2)Weekly
        3)Select Monday–Friday
        4)Set the time:
        5)Buy task → shortly before market open
        6)Sell task → shortly before market close
